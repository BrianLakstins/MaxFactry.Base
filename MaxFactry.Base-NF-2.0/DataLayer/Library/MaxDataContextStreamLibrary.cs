...
namespace MaxFactry.Base.DataLayer
{
    ...
    /// </summary>
    public class MaxDataContextStreamLibrary : MaxSingleFactory
    {
        /// <summary>
        /// Internal storage of single object
        /// </summary>
        private static MaxDataContextStreamLibrary _oInstance = null;
        ...
        /// </summary>
        public static IMaxDataContextStreamLibraryProvider Provider
        {
            get
            {
        ...
        /// </summary>
        public static MaxDataContextStreamLibrary Instance
        {
            get
            {
                if (null == _oInstance)
                {
                    lock (_oLock)
                    {
                        if (null == _oInstance)
                        {
                            _oInstance = new MaxDataContextStreamLibrary();
                        }
                    }
                }
