// <copyright file="MaxSqlGenerationLibraryMSSql2000Provider.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Base.DataLayer.Library.Provider
{
	...
	/// </summary>
	public class MaxSqlGenerationLibraryMSSql2000Provider : MaxSqlGenerationLibraryDefaultProvider
	{
		/// <summary>
        /// Initializes a new instance of the MaxSqlGenerationLibraryMSSql2000Provider class
		/// </summary>
		public MaxSqlGenerationLibraryMSSql2000Provider()
		{
			...
			this.AddReplacement(string.Concat("MaxDefinitionType.", typeof(string), "."), "NVARCHAR(510)");
