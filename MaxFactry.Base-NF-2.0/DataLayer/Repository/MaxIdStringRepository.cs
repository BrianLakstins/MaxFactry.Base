...
namespace MaxFactry.Base.DataLayer
{
    ...
    public abstract class MaxIdStringRepository : MaxStorageWriteRepository
	{
        ...
        public static MaxData SelectById(MaxData loData, string lsId, params string[] laFields)
		{
            ...
            MaxDataList loList = SelectAllByProperty(loData, loDataModel.Id, lsId, laFields);
