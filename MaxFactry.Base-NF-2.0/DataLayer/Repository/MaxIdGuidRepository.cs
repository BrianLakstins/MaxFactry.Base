...
namespace MaxFactry.Base.DataLayer
{
    ...
    public abstract class MaxIdGuidRepository : MaxStorageWriteRepository
	{
        ...
        public static MaxData SelectById(MaxData loData, Guid loId, params string[] laFields)
		{
            ...
            MaxDataList loList = SelectAllByProperty(loData, loDataModel.Id, loId, laFields);
