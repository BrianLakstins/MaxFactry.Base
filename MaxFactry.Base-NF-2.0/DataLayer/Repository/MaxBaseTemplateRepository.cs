// <copyright file="MaxBaseTemplateRepository.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Template.DataLayer
{
	...
	/// </summary>
    public class MaxBaseTemplateRepository : MaxFactry.Base.DataLayer.MaxBaseIdRepository
	{
	}
}