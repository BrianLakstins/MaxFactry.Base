// <copyright file="MaxIdIntegerRepository.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Base.DataLayer
{
	...
	/// <summary>
    /// Provides static methods to manipulate storage of data using the MaxIdIntegerDataModel
	/// </summary>
    public abstract class MaxIdIntegerRepository : MaxStorageWriteRepository
	{
		/// <summary>
        ...
        public static MaxData SelectById(MaxData loData, int lnId, params string[] laDataNameList)
		{
            ...
            {
                throw new MaxException("Multiple records match the  Id [" + lnId.ToString() + "]");
            }
