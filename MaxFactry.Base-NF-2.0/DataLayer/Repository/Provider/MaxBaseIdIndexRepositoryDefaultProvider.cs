// <copyright file="MaxBaseIdIndexRepositoryDefaultProvider.cs" company="Lakstins Family, LLC">
...
// <change date="12/18/2014" author="Brian A. Lakstins" description="Moved data filter to repository.">
...
namespace MaxFactry.Base.DataLayer.Provider
{
	...
	/// </summary>
    public class MaxBaseIdIndexRepositoryDefaultProvider : MaxBaseIdRepositoryDefaultProvider, IMaxBaseIdIndexRepositoryProvider
	{
	}
}
